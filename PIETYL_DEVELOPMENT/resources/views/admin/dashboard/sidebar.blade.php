<div class="flex h-screen bg-gray-100">
    ...
    <aside class="w-64 bg-white shadow-lg flex flex-col justify-between">
        ...
        <nav class="flex-1 px-6 py-4">
            <ul class="space-y-2">
                <li class="flex items-center gap-4 px-4 py-3 rounded-2xl hover:bg-blue-50 cursor-pointer bg-[#DBEAFE] bg-opacity-50">
                    <img src="{{ asset('images/dashboardActive.png') }}" alt="Dashboard" class="w-10 h-10">
                    <span class="text-md font-medium">Dashboard</span>
                </li>
                <li class="flex items-center gap-4 px-4 py-3 rounded-2xl hover:bg-blue-50 cursor-pointer">
                ...
                <li class="flex items-center gap-4 px-4 py-3 rounded-2xl hover:bg-blue-50 cursor-pointer">
                    <img src="{{ asset('images/userInactive.png') }}" alt="Employee" class="w-10 h-10">
